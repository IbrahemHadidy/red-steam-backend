...
export class CreateGameDto {
  ...
  @IsNumber({}, { each: true, message: 'The developers of the game must be a number' })
  developers: number[];
  ...
  @IsNumber({}, { each: true, message: 'The publishers of the game must be a number' })
  publishers: number[];
  ...
  @IsObject({ message: 'The Image entries of the game must be an object', each: true })
  @IsOptional()
  imageEntries: {
    order: number;
    featured?: boolean;
  ...
  @IsObject({ message: 'The Video entries of the game must be an object', each: true })
  @IsOptional()
  videoEntries: {
    order: number;
  }[];
  ...
  @IsNumber({}, { each: true, message: 'The game tags must be a number' })
  tags: number[];
  ...
  @IsNumber({}, { each: true, message: 'The game features must be a number' })
  features: number[];
  ...
  @IsNotEmpty({ message: 'The game languages is required', each: true })
  @IsArray({ message: 'The game languages must be an array' })
  @IsObject({ message: 'The game languages must be an object', each: true })
  languages: {
    name: string;
    interface: boolean;
    fullAudio: boolean;
  ...
  @ApiProperty({ description: 'The game link', example: 'https://www.battlefield.com/', required: true })
  @IsNotEmpty({ message: 'The game link is required' })
